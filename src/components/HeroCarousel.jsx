              ...
              <div className="relative z-10 mx-auto h-full max-w-[1200px] px-6 md:px-10 lg:px-14 flex items-center gap-8">
                ...
                <div className="flex-1 max-w-2xl">
                  ...
                  <div className="mt-8 flex items-center gap-4">
                    {s.cta === "Find Your Coach" ? (
                      <button
                        onClick={() => setShowBMI(true)}
                        className="px-6 py-3 rounded-full text-white font-semibold bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 shadow-md transition"
                      >
                        {s.cta}
                      </button>
                    ) : (
